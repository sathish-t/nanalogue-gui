...
/** Compatibility exports for canonical Swipe review contracts. */
export type {
    BedAnnotation,
    SwipePlotData as PlotData,
    SwipePlotDataPoint as PlotDataPoint,
    SwipeWindowedPoint as WindowedPoint,
} from "./swipe-contract";
 ...
 */
export type { SwipeReviewState as AppState } from "./swipe-contract";
