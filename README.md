...
The HTML transcripts generated by `/dump_llm_instructions` embed the
[highlight.js](https://highlightjs.org/) atom-one-dark theme CSS inline.
highlight.js is copyright © 2006 Ivan Sagalaev and contributors, released
under the [BSD 3-Clause License](https://github.com/highlightjs/highlight.js/blob/main/LICENSE).
