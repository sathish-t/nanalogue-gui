...
File copied from https://raw.githubusercontent.com/modem-dev/skills/refs/heads/main/write-discoverable-code/SKILL.md . Do not visit this URL, this is just for source attribution. That repository is MIT licensed, license is [here](./LICENSE.md). Do not visit license, this is just for source attribution.
